...
<body>
    ...
    <header id="header" class="bg-black">
      <div class="containerd-flex align-items-center justify-content-between">
        <nav id="navbar" class="navbar">
          <ul>
            <li><a class="nav-link scrollto renkdegis" style="font-size: 25px;" href="index.html">Öneriler - Ana Sayfa</a></li>
            <li><a class="nav-link scrollto" href="mailto:memkogeskiletisim@gmail.com?
              &subject=Gönüllü Okuyucu İstek &body=Lütfen belirtilenleri doldurunuz:
              İsim :
              Soyisim :  
              Yaşadığınız il : ">Gönüllü Okuyucu Ol!</a></li>
          </ul>
    ...
    <div>
      <div class="col- btn-1">
        <div class=buttons>
          ...
          <noscript id="description">sonunda</noscript>
        </div>
      </div>
      <div class="btn-1">
        <div class=buttons>
      ...
      <div>
        <button class="btn-1" type="button">#Örnek</button>
        <button class="btn-1" type="button">#Örnek</button>
        <button class="btn-1" type="button">#Örnek</button>
        <button class="btn-1" type="button">#Örnek</button>
        <button class="btn-1" type="button">#Örnek</button>
...
//end select voices
        ...
        function onClickPlay() {
            if (!flag) {
                ...
                //add voice//
                var selectedOption = voiceSelect.selectedOptions[0].getAttribute(4);
                    for(i = 0; i < voices.length ; i++) {
